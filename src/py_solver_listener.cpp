...
namespace ratio::python
{
    ...
    void py_solver_listener::resolver_created(const ratio::solver::resolver &r)
    {
        ...
        py_slv.attr("fire_resolver_created")(get_id(r), get_id(r.get_effect()), r.get_data().dump(), pybind11::module_::import("oRatio.rational").attr("Rational")(intr_cost.numerator(), intr_cost.denominator()), slv.get_sat_core()->value(r.get_rho()));
    }
